FlagVisualizer:
    type: task
    debug: false
    definitions: flag[Object]|flagName[ElementTag(String)]|player[?PlayerTag]
    description:
    ...
    - define __player <[player]> if:<[player].exists>
...
FlagVisualizer_Recur:
    ...
    - choose <[flag].object_type>:
        ...
        - case Item:
            - define itemPropertiesList <map[]> if:<[flag].material.name.equals[air]>
            - define itemPropertiesList <[itemPropertiesList].if_null[<[flag].property_map>]>
    ...
    - else if <context.args.size> == 2:
        - if <context.args.get[2].contains[.]>:
            ...
            - if <[currentKey]> != <[firstKey]>:
                ...
                - define keys <player.location.world.flag[<[adjustedKeyList]>].keys.filter_tag[<[filter_value].advanced_matches[<[currentKey]>].or[<[filter_value].starts_with[<[currentKey]>]>]>]> if:<[object].equals[world]>
            ...
            - else:
                ...
                - else if <[object]> == world:
                    - define keys <player.location.world.flag[<[currentKey]>].keys>
